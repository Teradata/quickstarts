...
=== Calling Query Service APIs using JWT

Prerequisites for JWT authentication:

1. The user for whom the JWT is created, needs to be present in the database

2. The database needs to be JWT enabled.
...
----
{"queueDuration":3,"queryDuration":36,"results":[{"resultSet":true,"data":[{"InfoKey":"LANGUAGE SUPPORT MODE","InfoData":"Standard"},{"InfoKey":"RELEASE","InfoData":"15.10.07.02"},{"InfoKey":"VERSION","InfoData":"15.10.07.02"}],"rowCount":3,"rowLimitExceeded":false}]}
----
