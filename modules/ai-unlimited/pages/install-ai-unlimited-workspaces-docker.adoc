...
* <<_deploy_workspaces_using_docker_engine,Docker Engine>>
* <<_deploy_workspaces_using_docker_compose, Docker Compose>>
...
|Permission Boundary
|The maximum permissions an IAM entity can have regardless of the permissions defined in the identity-based policy. You can define and manage the permissions of the users and roles and enforce compliance requirements.
|No
|===
