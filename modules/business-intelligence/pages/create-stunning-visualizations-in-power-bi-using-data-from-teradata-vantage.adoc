= Connect Teradata Vantage to Power BI Desktop
:experimental:
...
image::{page-image-directory}/power.bi.splash.screen.png[Power BI splash screen, width=500]
...
image::{page-image-directory}/power.bi.get.data.menu.png[Power BI Get Data menu, width=500]
...
image::{page-image-directory}/power.bi.database.picker.png[Power BI Database picker, width=700]
...
image::{page-image-directory}/power.bi.server.connect.png[Power BI server connection, width=700]
...
image::{page-image-directory}/power.bi.ldap.png[Power BI LDAP connection, width=700]
...
image::{page-image-directory}/power.bi.navigator.png[Power BI Navigator, width=900]
...
image::{page-image-directory}/power.bi.workspace.png[Power BI publish to my workspace, width=900]

Once report has been published, click _Got it_ to close. You may also click the link, which has the report name in the link.

image::{page-image-directory}/power.bi.success.png[Power BI successfully published, width=900]

This is an example of a report created in Power BI Desktop.

image::{page-image-directory}/power.bi.report.png[Power BI Report, width=150%]
