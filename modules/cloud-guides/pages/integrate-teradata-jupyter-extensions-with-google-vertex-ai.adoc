...
image:{page-image-directory}/vertex.create.notebook.startupscript.png[create a new notebook with startup script, width=100%]

It may take a few minutes for the notebook creation process to complete. When it is done, click on 'Open notebook'.

image:{page-image-directory}/vertex.open.notebook.png[Open notebook, width=100%]
...
image:{page-image-directory}/vertex.custom.container.png[Open notebook, width=100%]
