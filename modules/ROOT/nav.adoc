...
** xref:airflow:airflow.adoc[]
** xref:airflow:airflow-azure-to-teradata-transfer-operator-doc.adoc[]
** xref:airflow:airflow-s3-to-teradata-transfer-operator-doc.adoc[]
