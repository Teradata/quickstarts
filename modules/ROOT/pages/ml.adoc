...
1. VAL is distributed as an rpm file. Go to link:https://downloads.teradata.com/download/database/val-download-page[Teradata Downloads] and download the VAL rpm to your local machine.
