...
. The latest version of link:https://downloads.teradata.com/download/database/teradata-express-for-vmware-player[Teradata Express for VMware Player]. If you have not used the Teradata downloads website before, you will need to register.
. link:https://www.vmware.com/products/workstation-player.html[VMware Workstation Player].
+
IMPORTANT: Commercial organizations require commercial licenses to use VMware Workstation Player. If you don't want to acquire licenses you can xref:getting.started.vbox.adoc[run Teradata Express on VirtualBox].
+
IMPORTANT: VMware doesn't offer VMware Workstation Player for MacOS. If you are on a Mac, you will need to install link:https://www.vmware.com/products/fusion/fusion-evaluation.html[VMware Fusion] instead. It's a paid product but VMware offers a free 30-day trial. Alternatively, you can xref:getting.started.vbox.adoc[run Teradata Express on VirtualBox].
. On Windows, you will also need link:https://www.7-zip.org/download.html[7zip] to unzip Teradata Express.
