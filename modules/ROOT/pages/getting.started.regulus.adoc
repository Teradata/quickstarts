...
+
Replace the <Project_Name> for your system. The size parameter value can be small, medium, large, or extralarge. The default size is small.
+
...
* Interested in exploring advanced use cases? See <GitHub Sample link>.
