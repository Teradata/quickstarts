...
3. A Vantage Express instance that GCP Cloud run can talk to. The easiest way to start on your own is to run a xref:vantage.express.gcp.adoc[Vantage Express instance in GCP].
