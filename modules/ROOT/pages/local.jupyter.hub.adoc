...
* link:https://downloads.teradata.com/download/aster/teradata-python-package-teradataml[Teradata Package for Python - teradataml download page]
* link:https://downloads.teradata.com/download/aster/tdplyr-download-page[Teradata Package for R - tdplyr download page]
