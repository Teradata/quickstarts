...
* Azureサブスクリプションまたはhttps://azure.microsoft.com/free/[無料アカウント]
作成* https://docs.microsoft.com/en-us/azure/machine-learning/studio/create-workspace[Azure ML Studio ワークスペース]
...
80%は機械学習モデルの学習用、20%はモデルのテスト用としてデータを80対20に分割します。この2値分類問題には、「2クラス」アルゴリズムを使用します。
