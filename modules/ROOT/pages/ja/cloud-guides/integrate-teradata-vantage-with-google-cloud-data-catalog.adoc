...
されている* https://www.python.org/downloads/[Python ]が インストールされている
* https://pip.pypa.io/en/stable/installation/[Pip]ががインストールされている
...
* Googleのログインページが開くので、Googleアカウントを選択し、次のページで_Allow_をクリックします。
