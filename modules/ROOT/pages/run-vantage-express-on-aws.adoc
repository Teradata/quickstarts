...
If you do not wish to pay for cloud usage, you can get a free hosted instance of Vantage at link:https://clearscape.teradata.com/[]. Alternatively, you install Vantage Express locally using xref:getting.started.vmware.adoc[VMware], xref:getting.started.vbox.adoc[VirtualBox], or xref:getting.started.utm.adoc[UTM].
====
