...
== For any questions.
link:https://support.teradata.com/community?id=community_forum&sys_id=353d17d44fed7f00dcf7a6118110c7b5&utm_source=dev_portal&utm_medium=quickstart_tutorial&utm_campaign=advanced_dbt[Contact us in our community., window="_blank"]

utm_source: dev_portal

Medium = quickstart_tutorial ???

utm_campaign = advanced_dbt