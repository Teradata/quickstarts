...
This tutorial is based on a s3 aws object storage.
...
NOTE: assuming you already have a database created. 
If you havent you can create a database with the following sintaxis: create user db as perm=10e7, password=db; 
...
Your table should llok something like this: 
----
...
NOTE: Now you have created the parquet file on your NOS s3 bucket. Now to easyly query your file you need to follow step number 4.
...
== Further reading
* link:https://docs.teradata.com/r/Teradata-VantageTM-Native-Object-Store-Getting-Started-Guide/January-2021/Writing-Data-to-External-Object-Store[Teradata Vantage™ - Writing Data to External Object Store]