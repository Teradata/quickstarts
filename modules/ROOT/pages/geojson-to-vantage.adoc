...
Consider using https://pypi.org/project/teradatasqlalchemy/[SQLAlchemy ORM] if you are defining your pipeline in Python, 
include::partial$dbt.adoc[dbt]
, or your favourite ELT and orchestration toolset to create your products you can operationalize.
