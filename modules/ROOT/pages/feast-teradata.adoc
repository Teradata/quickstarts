...
:experimental:
:page-author: Mohammmad Taha Wahab & Mohammad Harris Mansur
:page-email: mohammadtaha.wahab@teradata.com & mohammadharris.mansur@teradata.com
...
You can also add your own data and make your own features which can then be tested using the tet_workflow.py file as mentioned above.
