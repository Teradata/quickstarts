...
image::{page-image-directory}/power.bi.splash.screen.png[Power BI splash screen, width=900]
...
image::{page-image-directory}/power.bi.get.data.menu.png[Power BI Get Data menu, width=900]
