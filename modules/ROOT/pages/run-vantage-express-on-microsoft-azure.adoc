...
:page-revdate: February 16th, 2022
...
This how-to demonstrates how to run Vantage Express in Microsoft Azure. Running Vantage Express in the cloud is the quickest way to get access to a fully functional Teradata SQL Engine.
