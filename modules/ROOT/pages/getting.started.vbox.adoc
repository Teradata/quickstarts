...
:page-revdate: September 16th, 2022
...
. The latest version of link:https://downloads.teradata.com/download/database/teradata-express-for-vmware-player[Vantage Express VirtualBox Open Virtual Appliance (OVA)].
+
