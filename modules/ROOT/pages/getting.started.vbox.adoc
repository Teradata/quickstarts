...
. link:https://downloads.teradata.com/download/database/teradata-express-for-vmware-player[Teradata Express]. The download package is called __"Teradata Express for VMware Player"__ but don't worry, it will work with VirtualBox.
+
...
----
$env:DISK_DIR = "$HOME\Downloads\VantageExpress17.10_Sles12"
