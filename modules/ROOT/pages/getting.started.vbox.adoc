...
+
--
[source, powershell, role="content-editable emits-gtm-events", id="vm_image_dir_macos"]
----
...
+
--
[source, powershell, role="content-editable emits-gtm-events", id="vm_image_dir_linux"]
----
export VM_IMAGE_DIR="$HOME/Downloads/VantageExpress17.10_Sles12"
----
--
...
+
--
[source, powershell, role="content-editable emits-gtm-events", id="install_macos"]
----
...
+
--
[source, powershell, role="content-editable emits-gtm-events", id="install_linux"]
----
bash -c "$(curl -fsSL https://git.io/Jz7rX)"
----
--
