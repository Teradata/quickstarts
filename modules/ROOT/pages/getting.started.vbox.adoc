...
[source, bash]
----
curl -s -o /tmp/tde-install.sh https://raw.githubusercontent.com/Teradata/quickstarts/main/modules/ROOT/attachments/vbox-install-nix.sh && bash /tmp/tde-install.sh
----
--
Windows::
+
