...
. link:https://downloads.teradata.com/download/database/teradata-express-for-vmware-player[Teradata Express] VM image. The download package is called __"Teradata Express for VMware Player"__ but don't worry, it will work with VirtualBox.
+
