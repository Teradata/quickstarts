...
[source, bash]
----
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Teradata/quickstarts/main/modules/ROOT/attachments/vbox-install.sh)"
----
--
Windows::
+
...
[source, powershell]
----
iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/Teradata/quickstarts/main/modules/ROOT/attachments/vbox-install.ps1'))
----
--
Linux::
+
