...
----
%project_engine_deploy project=<Project_Name>, size=<Size_of_Engine>, node=<Number_of_Nodes>, vpc=<vpc_id>, subnet=<Subnet_id>, region=<Region>, azs=<Avalability_Zone>
----
Where:
...
* [Optional] azs:	Availability zone for the query engine.	
