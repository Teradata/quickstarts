...
== Prerequisites
* Access to a Teradata Vantage Instance. This will be defined as the destination in Airbyte. You will need a database `Host`, `Username`, and `Password` for Airbyte’s configuration.
+
