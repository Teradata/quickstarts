...
== Overview
This quickstart details the process for running the https://github.com/Teradata/lake-demos[Teradata Jupyter Notebook Demos for Vantage Cloud Lake], on Amazon SageMaker, the AI/ML platform from Amazon AWS.
